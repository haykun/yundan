<template>
    <div style="width:100%">
        <el-cascader :options="pcdOptions" v-model="selectedOptions" filterable clearable @change="valueChanged" >
        </el-cascader>  
    </div>
</template>
...
<script>
export default {
    props: ['tempPcdText'], //必须，实现从父组件向子组件赋值用
    data(){
        return{
        pcdOptions: [
            {value: '110000', label: '北京市', children:[{value: '110100', label: '北京市', children:[{value: '110101', label: '东城区'}
            ...
            {value: '120000', label: '天津市', children:[{value: '120100', label: '天津市', children:[{value: '120101', label: '和平区'}
            ...
            {value: '130000', label: '河北省', children:[{value: '130600', label: '保定市', children:[{value: '130602', label: '竞秀区'}
            ...
            , {value: '130200', label: '唐山市', children:[{value: '130202', label: '路南区'}
            ...
            , {value: '131000', label: '廊坊市', children:[{value: '131002', label: '安次区'}
            ...
            , {value: '130700', label: '张家口市', children:[{value: '130702', label: '桥东区'}
            ...
            , {value: '130800', label: '承德市', children:[{value: '130802', label: '双桥区'}
            ...
            , {value: '130900', label: '沧州市', children:[{value: '130902', label: '新华区'}
            ...
            , {value: '130100', label: '石家庄市', children:[{value: '130102', label: '长安区'}
            ...
            , {value: '130300', label: '秦皇岛市', children:[{value: '130302', label: '海港区'}
            ...
            , {value: '131100', label: '衡水市', children:[{value: '131102', label: '桃城区'}
            ...
            , {value: '130500', label: '邢台市', children:[{value: '130502', label: '桥东区'}
            ...
            , {value: '130400', label: '邯郸市', children:[{value: '130402', label: '邯山区'}
            ...
            {value: '140000', label: '山西省', children:[{value: '141000', label: '临汾市', children:[{value: '141002', label: '尧都区'}
            ...
            , {value: '140200', label: '大同市', children:[{value: '140202', label: '城区'}
            ...
            , {value: '140100', label: '太原市', children:[{value: '140105', label: '小店区'}
            ...
            , {value: '140700', label: '晋中市', children:[{value: '140702', label: '榆次区'}
            ...
            , {value: '140600', label: '朔州市', children:[{value: '140602', label: '朔城区'}
            ...
            , {value: '140300', label: '阳泉市', children:[{value: '140302', label: '城区'}
            ...
            {value: '150000', label: '内蒙古自治区', children:[{value: '150900', label: '乌兰察布市', children:[{value: '150902', label: '集宁区'}
            ...
            , {value: '150300', label: '乌海市', children:[{value: '150302', label: '海勃湾区'}
            ...
            , {value: '152200', label: '兴安盟', children:[{value: '152201', label: '乌兰浩特市'}
            ...
            , {value: '150200', label: '包头市', children:[{value: '150202', label: '东河区'}
            ...
            , {value: '150700', label: '呼伦贝尔市', children:[{value: '150702', label: '海拉尔区'}
            ...
            , {value: '150100', label: '呼和浩特市', children:[{value: '150102', label: '新城区'}
            ...
            , {value: '150800', label: '巴彦淖尔市', children:[{value: '150802', label: '临河区'}
            ...
            , {value: '150500', label: '通辽市', children:[{value: '150502', label: '科尔沁区'}
            ...
            , {value: '150600', label: '鄂尔多斯市', children:[{value: '150602', label: '东胜区'}
            ...
            , {value: '152500', label: '锡林郭勒盟', children:[{value: '152501', label: '二连浩特市'}
            ...
            , {value: '152900', label: '阿拉善盟', children:[{value: '152921', label: '阿拉善左旗'}
            , {value: '152922', label: '阿拉善右旗'}
            , {value: '152923', label: '额济纳旗'}
            ]}
            ]},
            {value: '210000', label: '辽宁省', children:[{value: '210600', label: '丹东市', children:[{value: '210602', label: '元宝区'}
            ...
            , {value: '210200', label: '大连市', children:[{value: '210202', label: '中山区'}
            ...
            , {value: '210400', label: '抚顺市', children:[{value: '210402', label: '新抚区'}
            ...
            , {value: '211300', label: '朝阳市', children:[{value: '211302', label: '双塔区'}
            ...
            , {value: '210500', label: '本溪市', children:[{value: '210502', label: '平山区'}
            ...
            , {value: '210100', label: '沈阳市', children:[{value: '210102', label: '和平区'}
            ...
            , {value: '211100', label: '盘锦市', children:[{value: '211102', label: '双台子区'}
            , {value: '211103', label: '兴隆台区'}
            , {value: '211104', label: '大洼区'}
            , {value: '211122', label: '盘山县'}
            ]}
            , {value: '210800', label: '营口市', children:[{value: '210802', label: '站前区'}
            ...
            , {value: '211400', label: '葫芦岛市', children:[{value: '211402', label: '连山区'}
            ...
            , {value: '211000', label: '辽阳市', children:[{value: '211002', label: '白塔区'}
            ...
            , {value: '211200', label: '铁岭市', children:[{value: '211202', label: '银州区'}
            ...
            , {value: '210700', label: '锦州市', children:[{value: '210702', label: '古塔区'}
            ...
            , {value: '210900', label: '阜新市', children:[{value: '210902', label: '海州区'}
            ...
            , {value: '210300', label: '鞍山市', children:[{value: '210302', label: '铁东区'}
            ...
            {value: '220000', label: '吉林省', children:[{value: '220200', label: '吉林市', children:[{value: '220202', label: '昌邑区'}
            ...
            , {value: '220300', label: '四平市', children:[{value: '220302', label: '铁西区'}
            ...
            , {value: '222400', label: '延边朝鲜族自治州', children:[{value: '222401', label: '延吉市'}
            ...
            , {value: '220400', label: '辽源市', children:[{value: '220402', label: '龙山区'}
            , {value: '220403', label: '西安区'}
            , {value: '220421', label: '东丰县'}
            , {value: '220422', label: '东辽县'}
            ]}
            , {value: '220500', label: '通化市', children:[{value: '220502', label: '东昌区'}
            ...
            , {value: '220100', label: '长春市', children:[{value: '220102', label: '南关区'}
            ...
            {value: '230000', label: '黑龙江省', children:[{value: '230900', label: '七台河市', children:[{value: '230902', label: '新兴区'}
            , {value: '230903', label: '桃山区'}
            , {value: '230904', label: '茄子河区'}
            , {value: '230921', label: '勃利县'}
            ]}
            , {value: '230700', label: '伊春市', children:[{value: '230702', label: '伊春区'}
            ...
            , {value: '230800', label: '佳木斯市', children:[{value: '230803', label: '向阳区'}
            ...
            , {value: '230500', label: '双鸭山市', children:[{value: '230502', label: '尖山区'}
            ...
            , {value: '230100', label: '哈尔滨市', children:[{value: '230102', label: '道里区'}
            ...
            , {value: '232700', label: '大兴安岭地区', children:[{value: '232701', label: '加格达奇区'}
            ...
            , {value: '230600', label: '大庆市', children:[{value: '230602', label: '萨尔图区'}
            ...
            , {value: '231000', label: '牡丹江市', children:[{value: '231002', label: '东安区'}
            ...
            , {value: '231200', label: '绥化市', children:[{value: '231202', label: '北林区'}
            ...
            , {value: '230300', label: '鸡西市', children:[{value: '230302', label: '鸡冠区'}
            ...
            , {value: '230400', label: '鹤岗市', children:[{value: '230402', label: '向阳区'}
            ...
            , {value: '231100', label: '黑河市', children:[{value: '231102', label: '爱辉区'}
            ...
            , {value: '230200', label: '齐齐哈尔市', children:[{value: '230202', label: '龙沙区'}
            ...
            {value: '310000', label: '上海市', children:[{value: '310100', label: '上海市', children:[{value: '310101', label: '黄浦区'}
            ...
            {value: '320000', label: '江苏省', children:[{value: '320100', label: '南京市', children:[{value: '320102', label: '玄武区'}
            ...
            , {value: '320600', label: '南通市', children:[{value: '320602', label: '崇川区'}
            ...
            , {value: '320400', label: '常州市', children:[{value: '320402', label: '天宁区'}
            ...
            , {value: '320300', label: '徐州市', children:[{value: '320302', label: '鼓楼区'}
            ...
            , {value: '321000', label: '扬州市', children:[{value: '321002', label: '广陵区'}
            ...
            , {value: '320200', label: '无锡市', children:[{value: '320205', label: '锡山区'}
            ...
            , {value: '321200', label: '泰州市', children:[{value: '321202', label: '海陵区'}
            ...
            , {value: '320800', label: '淮安市', children:[{value: '320803', label: '淮安区'}
            ...
            , {value: '320900', label: '盐城市', children:[{value: '320902', label: '亭湖区'}
            ...
            , {value: '320500', label: '苏州市', children:[{value: '320505', label: '虎丘区'}
            ...
            , {value: '320700', label: '连云港市', children:[{value: '320703', label: '连云区'}
            ...
            , {value: '321100', label: '镇江市', children:[{value: '321102', label: '京口区'}
            ...
            {value: '330000', label: '浙江省', children:[{value: '331100', label: '丽水市', children:[{value: '331102', label: '莲都区'}
            ...
            , {value: '331000', label: '台州市', children:[{value: '331002', label: '椒江区'}
            ...
            , {value: '330400', label: '嘉兴市', children:[{value: '330402', label: '南湖区'}
            ...
            , {value: '330200', label: '宁波市', children:[{value: '330203', label: '海曙区'}
            ...
            , {value: '330300', label: '温州市', children:[{value: '330302', label: '鹿城区'}
            ...
            , {value: '330500', label: '湖州市', children:[{value: '330502', label: '吴兴区'}
            , {value: '330503', label: '南浔区'}
            , {value: '330521', label: '德清县'}
            , {value: '330522', label: '长兴县'}
            , {value: '330523', label: '安吉县'}
            ]}
            , {value: '330600', label: '绍兴市', children:[{value: '330602', label: '越城区'}
            ...
            , {value: '330900', label: '舟山市', children:[{value: '330902', label: '定海区'}
            , {value: '330903', label: '普陀区'}
            , {value: '330921', label: '岱山县'}
            , {value: '330922', label: '嵊泗县'}
            ]}
            , {value: '330800', label: '衢州市', children:[{value: '330802', label: '柯城区'}
            ...
            , {value: '330700', label: '金华市', children:[{value: '330702', label: '婺城区'}
            ...
            {value: '340000', label: '安徽省', children:[{value: '341600', label: '亳州市', children:[{value: '341602', label: '谯城区'}
            , {value: '341621', label: '涡阳县'}
            , {value: '341622', label: '蒙城县'}
            , {value: '341623', label: '利辛县'}
            ]}
            , {value: '341500', label: '六安市', children:[{value: '341502', label: '金安区'}
            ...
            , {value: '340100', label: '合肥市', children:[{value: '340102', label: '瑶海区'}
            ...
            , {value: '340800', label: '安庆市', children:[{value: '340802', label: '迎江区'}
            ...
            , {value: '341800', label: '宣城市', children:[{value: '341802', label: '宣州区'}
            ...
            , {value: '341300', label: '宿州市', children:[{value: '341302', label: '埇桥区'}
            ...
            , {value: '341700', label: '池州市', children:[{value: '341702', label: '贵池区'}
            , {value: '341721', label: '东至县'}
            , {value: '341722', label: '石台县'}
            , {value: '341723', label: '青阳县'}
            ]}
            , {value: '340600', label: '淮北市', children:[{value: '340602', label: '杜集区'}
            , {value: '340603', label: '相山区'}
            , {value: '340604', label: '烈山区'}
            , {value: '340621', label: '濉溪县'}
            ]}
            , {value: '340400', label: '淮南市', children:[{value: '340402', label: '大通区'}
            ...
            , {value: '341100', label: '滁州市', children:[{value: '341102', label: '琅琊区'}
            ...
            , {value: '340200', label: '芜湖市', children:[{value: '340202', label: '镜湖区'}
            ...
            , {value: '340300', label: '蚌埠市', children:[{value: '340302', label: '龙子湖区'}
            ...
            , {value: '340700', label: '铜陵市', children:[{value: '340705', label: '铜官区'}
            , {value: '340706', label: '义安区'}
            , {value: '340711', label: '郊区'}
            ]}
            , {value: '341200', label: '阜阳市', children:[{value: '341202', label: '颍州区'}
            ...
            , {value: '340500', label: '马鞍山市', children:[{value: '340503', label: '花山区'}
            , {value: '340504', label: '雨山区'}
            , {value: '340506', label: '博望区'}
            , {value: '340521', label: '当涂县'}
            ]}
            , {value: '341000', label: '黄山市', children:[{value: '341002', label: '屯溪区'}
            ...
            {value: '350000', label: '福建省', children:[{value: '350400', label: '三明市', children:[{value: '350402', label: '梅列区'}
            ...
            , {value: '350700', label: '南平市', children:[{value: '350702', label: '延平区'}
            ...
            , {value: '350200', label: '厦门市', children:[{value: '350203', label: '思明区'}
            ...
            , {value: '350900', label: '宁德市', children:[{value: '350902', label: '蕉城区'}
            ...
            , {value: '350500', label: '泉州市', children:[{value: '350502', label: '鲤城区'}
            ...
            , {value: '350600', label: '漳州市', children:[{value: '350602', label: '芗城区'}
            ...
            , {value: '350100', label: '福州市', children:[{value: '350102', label: '鼓楼区'}
            ...
            , {value: '350300', label: '莆田市', children:[{value: '350302', label: '城厢区'}
            , {value: '350303', label: '涵江区'}
            , {value: '350304', label: '荔城区'}
            , {value: '350305', label: '秀屿区'}
            , {value: '350322', label: '仙游县'}
            ]}
            , {value: '350800', label: '龙岩市', children:[{value: '350802', label: '新罗区'}
            ...
            {value: '360000', label: '江西省', children:[{value: '361100', label: '上饶市', children:[{value: '361102', label: '信州区'}
            ...
            , {value: '360400', label: '九江市', children:[{value: '360402', label: '濂溪区'}
            ...
            , {value: '360100', label: '南昌市', children:[{value: '360102', label: '东湖区'}
            ...
            , {value: '360800', label: '吉安市', children:[{value: '360802', label: '吉州区'}
            ...
            , {value: '360900', label: '宜春市', children:[{value: '360902', label: '袁州区'}
            ...
            , {value: '361000', label: '抚州市', children:[{value: '361002', label: '临川区'}
            ...
            , {value: '360500', label: '新余市', children:[{value: '360502', label: '渝水区'}
            , {value: '360521', label: '分宜县'}
            ]}
            , {value: '360200', label: '景德镇市', children:[{value: '360202', label: '昌江区'}
            , {value: '360203', label: '珠山区'}
            , {value: '360222', label: '浮梁县'}
            , {value: '360281', label: '乐平市'}
            ]}
            , {value: '360300', label: '萍乡市', children:[{value: '360302', label: '安源区'}
            , {value: '360313', label: '湘东区'}
            , {value: '360321', label: '莲花县'}
            , {value: '360322', label: '上栗县'}
            , {value: '360323', label: '芦溪县'}
            ]}
            , {value: '360700', label: '赣州市', children:[{value: '360702', label: '章贡区'}
            ...
            , {value: '360600', label: '鹰潭市', children:[{value: '360602', label: '月湖区'}
            , {value: '360622', label: '余江县'}
            , {value: '360681', label: '贵溪市'}
            ]}
            ]},
            {value: '370000', label: '山东省', children:[{value: '370500', label: '东营市', children:[{value: '370502', label: '东营区'}
            , {value: '370503', label: '河口区'}
            , {value: '370505', label: '垦利区'}
            , {value: '370522', label: '利津县'}
            , {value: '370523', label: '广饶县'}
            ]}
            , {value: '371300', label: '临沂市', children:[{value: '371302', label: '兰山区'}
            ...
            , {value: '371000', label: '威海市', children:[{value: '371002', label: '环翠区'}
            , {value: '371003', label: '文登区'}
            , {value: '371082', label: '荣成市'}
            , {value: '371083', label: '乳山市'}
            ]}
            , {value: '371400', label: '德州市', children:[{value: '371402', label: '德城区'}
            ...
            , {value: '371100', label: '日照市', children:[{value: '371102', label: '东港区'}
            , {value: '371103', label: '岚山区'}
            , {value: '371121', label: '五莲县'}
            , {value: '371122', label: '莒县'}
            ]}
            , {value: '370400', label: '枣庄市', children:[{value: '370402', label: '市中区'}
            ...
            , {value: '370900', label: '泰安市', children:[{value: '370902', label: '泰山区'}
            ...
            , {value: '370100', label: '济南市', children:[{value: '370102', label: '历下区'}
            ...
            , {value: '370800', label: '济宁市', children:[{value: '370802', label: '市中区'}
            ...
            , {value: '370300', label: '淄博市', children:[{value: '370302', label: '淄川区'}
            ...
            , {value: '371600', label: '滨州市', children:[{value: '371602', label: '滨城区'}
            ...
            , {value: '370700', label: '潍坊市', children:[{value: '370702', label: '潍城区'}
            ...
            , {value: '370600', label: '烟台市', children:[{value: '370602', label: '芝罘区'}
            ...
            , {value: '371500', label: '聊城市', children:[{value: '371502', label: '东昌府区'}
            ...
            , {value: '371200', label: '莱芜市', children:[{value: '371202', label: '莱城区'}
            , {value: '371203', label: '钢城区'}
            ]}
            , {value: '371700', label: '菏泽市', children:[{value: '371702', label: '牡丹区'}
            ...
            , {value: '370200', label: '青岛市', children:[{value: '370202', label: '市南区'}
            ...
            {value: '410000', label: '河南省', children:[{value: '411200', label: '三门峡市', children:[{value: '411202', label: '湖滨区'}
            ...
            , {value: '411500', label: '信阳市', children:[{value: '411502', label: '浉河区'}
            ...
            , {value: '411300', label: '南阳市', children:[{value: '411302', label: '宛城区'}
            ...
            , {value: '411600', label: '周口市', children:[{value: '411602', label: '川汇区'}
            ...
            , {value: '411400', label: '商丘市', children:[{value: '411402', label: '梁园区'}
            ...
            , {value: '410500', label: '安阳市', children:[{value: '410502', label: '文峰区'}
            ...
            , {value: '410400', label: '平顶山市', children:[{value: '410402', label: '新华区'}
            ...
            , {value: '410200', label: '开封市', children:[{value: '410202', label: '龙亭区'}
            ...
            , {value: '410700', label: '新乡市', children:[{value: '410702', label: '红旗区'}
            ...
            , {value: '410300', label: '洛阳市', children:[{value: '410302', label: '老城区'}
            ...
            , {value: '411100', label: '漯河市', children:[{value: '411102', label: '源汇区'}
            ...
            , {value: '410800', label: '焦作市', children:[{value: '410802', label: '解放区'}
            ...
            , {value: '411000', label: '许昌市', children:[{value: '411002', label: '魏都区'}
            ...
            , {value: '410100', label: '郑州市', children:[{value: '410102', label: '中原区'}
            ...
            , {value: '410600', label: '鹤壁市', children:[{value: '410602', label: '鹤山区'}
            ...
            {value: '420000', label: '湖北省', children:[{value: '420900', label: ' 孝感市', children:[{value: '420902', label: '孝南区'}
            ...
            , {value: '420300', label: '十堰市', children:[{value: '420302', label: '茅箭区'}
            ...
            , {value: '421200', label: '咸宁市', children:[{value: '421202', label: '咸安区'}
            ...
            , {value: '420500', label: '宜昌市', children:[{value: '420502', label: '西陵区'}
            ...
            , {value: '422800', label: '恩施土家族苗族自治州', children:[{value: '422801', label: '恩施市'}
            ...
            , {value: '420100', label: '武汉市', children:[{value: '420102', label: '江岸区'}
            ...
            , {value: '421000', label: '荆州市', children:[{value: '421002', label: '沙市区'}
            ...
            , {value: '420800', label: '荆门市', children:[{value: '420802', label: '东宝区'}
            , {value: '420804', label: '掇刀区'}
            , {value: '420821', label: '京山县'}
            , {value: '420822', label: '沙洋县'}
            , {value: '420881', label: '钟祥市'}
            ]}
            , {value: '420600', label: '襄阳市', children:[{value: '420602', label: '襄城区'}
            ...
            , {value: '420700', label: '鄂州市', children:[{value: '420702', label: '梁子湖区'}
            , {value: '420703', label: '华容区'}
            , {value: '420704', label: '鄂城区'}
            ]}
            , {value: '421300', label: '随州市', children:[{value: '421303', label: '曾都区'}
            , {value: '421321', label: '随县'}
            , {value: '421381', label: '广水市'}
            ]}
            , {value: '421100', label: '黄冈市', children:[{value: '421102', label: '黄州区'}
            ...
            , {value: '420200', label: '黄石市', children:[{value: '420202', label: '黄石港区'}
            ...
            {value: '430000', label: '湖南省', children:[{value: '431300', label: '娄底市', children:[{value: '431302', label: '娄星区'}
            , {value: '431321', label: '双峰县'}
            , {value: '431322', label: '新化县'}
            , {value: '431381', label: '冷水江市'}
            , {value: '431382', label: '涟源市'}
            ]}
            , {value: '430600', label: '岳阳市', children:[{value: '430602', label: '岳阳楼区'}
            ...
            , {value: '430700', label: '常德市', children:[{value: '430702', label: '武陵区'}
            ...
            , {value: '430800', label: '张家界市', children:[{value: '430802', label: '永定区'}
            , {value: '430811', label: '武陵源区'}
            , {value: '430821', label: '慈利县'}
            , {value: '430822', label: '桑植县'}
            ]}
            , {value: '431200', label: '怀化市', children:[{value: '431202', label: '鹤城区'}
            ...
            , {value: '430200', label: '株洲市', children:[{value: '430202', label: '荷塘区'}
            ...
            , {value: '431100', label: '永州市', children:[{value: '431102', label: '零陵区'}
            ...
            , {value: '430300', label: '湘潭市', children:[{value: '430302', label: '雨湖区'}
            , {value: '430304', label: '岳塘区'}
            , {value: '430321', label: '湘潭县'}
            , {value: '430381', label: '湘乡市'}
            , {value: '430382', label: '韶山市'}
            ]}
            , {value: '433100', label: '湘西土家族苗族自治州', children:[{value: '433101', label: '吉首市'}
            ...
            , {value: '430900', label: '益阳市', children:[{value: '430902', label: '资阳区'}
            ...
            , {value: '430400', label: '衡阳市', children:[{value: '430405', label: '珠晖区'}
            ...
            , {value: '431000', label: '郴州市', children:[{value: '431002', label: '北湖区'}
            ...
            , {value: '430100', label: '长沙市', children:[{value: '430102', label: '芙蓉区'}
            ...
            {value: '440000', label: '广东省', children:[{value: '441900', label: '东莞市', children:[{value: '441900', label: '东莞市'}
            ]}
            ...
            , {value: '440600', label: '佛山市', children:[{value: '440604', label: '禅城区'}
            ...
            , {value: '441300', label: '惠州市', children:[{value: '441302', label: '惠城区'}
            ...
            , {value: '440500', label: '汕头市', children:[{value: '440507', label: '龙湖区'}
            ...
            , {value: '440700', label: '江门市', children:[{value: '440703', label: '蓬江区'}
            ...
            , {value: '440800', label: '湛江市', children:[{value: '440802', label: '赤坎区'}
            ...
            , {value: '440400', label: '珠海市', children:[{value: '440402', label: '香洲区'}
            , {value: '440403', label: '斗门区'}
            , {value: '440404', label: '金湾区'}
            ]}
            , {value: '441200', label: '肇庆市', children:[{value: '441202', label: '端州区'}
            ...
            , {value: '440900', label: '茂名市', children:[{value: '440902', label: '茂南区'}
            ...
            , {value: '440200', label: '韶关市', children:[{value: '440203', label: '武江区'}
            ...
            {value: '450000', label: '广西壮族自治区', children:[{value: '450500', label: '北海市', children:[{value: '450502', label: '海城区'}
            , {value: '450503', label: '银海区'}
            , {value: '450512', label: '铁山港区'}
            , {value: '450521', label: '合浦县'}
            ]}
            , {value: '450100', label: '南宁市', children:[{value: '450102', label: '兴宁区'}
            ...
            , {value: '451400', label: '崇左市', children:[{value: '451402', label: '江州区'}
            ...
            , {value: '451300', label: '来宾市', children:[{value: '451302', label: '兴宾区'}
            ...
            , {value: '450200', label: '柳州市', children:[{value: '450202', label: '城中区'}
            ...
            , {value: '450300', label: '桂林市', children:[{value: '450302', label: '秀峰区'}
            ...
            , {value: '450400', label: '梧州市', children:[{value: '450403', label: '万秀区'}
            ...
            , {value: '451200', label: '河池市', children:[{value: '451202', label: '金城江区'}
            ...
            , {value: '450900', label: '玉林市', children:[{value: '450902', label: '玉州区'}
            ...
            , {value: '451000', label: '百色市', children:[{value: '451002', label: '右江区'}
            ...
            , {value: '450800', label: '贵港市', children:[{value: '450802', label: '港北区'}
            , {value: '450803', label: '港南区'}
            , {value: '450804', label: '覃塘区'}
            , {value: '450821', label: '平南县'}
            , {value: '450881', label: '桂平市'}
            ]}
            , {value: '451100', label: '贺州市', children:[{value: '451102', label: '八步区'}
            , {value: '451103', label: '平桂区'}
            , {value: '451121', label: '昭平县'}
            , {value: '451122', label: '钟山县'}
            , {value: '451123', label: '富川瑶族自治县'}
            ]}
            , {value: '450700', label: '钦州市', children:[{value: '450702', label: '钦南区'}
            , {value: '450703', label: '钦北区'}
            , {value: '450721', label: '灵山县'}
            , {value: '450722', label: '浦北县'}
            ]}
            , {value: '450600', label: '防城港市', children:[{value: '450602', label: '港口区'}
            , {value: '450603', label: '防城区'}
            , {value: '450621', label: '上思县'}
            , {value: '450681', label: '东兴市'}
            ]}
            ]},
            {value: '460000', label: '海南省', children:[{value: '469006', label: '万宁市', children:[{value: '469006', label: '万宁市'}
            ]}
            , {value: '460200', label: '三亚市', children:[{value: '460202', label: '海棠区'}
            ...
            , {value: '469033', label: '中沙群岛的岛礁及其海域', children:[{value: '469033', label: '中沙群岛的岛礁及其海域'}
            ]}
            ...
            , {value: '469003', label: '儋州市', children:[{value: '469003', label: '儋州市'}
            ]}
            , {value: '469032', label: '南沙群岛', children:[{value: '469032', label: '南沙群岛'}
            ]}
            ...
            , {value: '460100', label: '海口市', children:[{value: '460105', label: '秀英区'}
            ...
            , {value: '469031', label: '西沙群岛', children:[{value: '469031', label: '西沙群岛'}
            ]}
            , {value: '469028', label: '陵水黎族自治县', children:[{value: '469028', label: '陵水黎族自治县'}
            ]}
            ]},
            {value: '500000', label: '重庆市', children:[{value: '500100', label: '重庆市', children:[{value: '500101', label: '万州区'}
            ...
            {value: '510000', label: '四川省', children:[{value: '511100', label: '乐山市', children:[{value: '511102', label: '市中区'}
            ...
            , {value: '511000', label: '内江市', children:[{value: '511002', label: '市中区'}
            ...
            , {value: '511300', label: '南充市', children:[{value: '511302', label: '顺庆区'}
            ...
            , {value: '511500', label: '宜宾市', children:[{value: '511502', label: '翠屏区'}
            ...
            , {value: '511900', label: '巴中市', children:[{value: '511902', label: '巴州区'}
            , {value: '511903', label: '恩阳区'}
            , {value: '511921', label: '通江县'}
            , {value: '511922', label: '南江县'}
            , {value: '511923', label: '平昌县'}
            ]}
            , {value: '510800', label: '广元市', children:[{value: '510802', label: '利州区'}
            ...
            , {value: '511600', label: '广安市', children:[{value: '511602', label: '广安区'}
            , {value: '511603', label: '前锋区'}
            , {value: '511621', label: '岳池县'}
            , {value: '511622', label: '武胜县'}
            , {value: '511623', label: '邻水县'}
            , {value: '511681', label: '华莹市'}
            ]}
            , {value: '510600', label: '德阳市', children:[{value: '510603', label: '旌阳区'}
            ...
            , {value: '510100', label: '成都市', children:[{value: '510104', label: '锦江区'}
            ...
            , {value: '510400', label: '攀枝花市', children:[{value: '510402', label: '东区'}
            , {value: '510403', label: '西区'}
            , {value: '510411', label: '仁和区'}
            , {value: '510421', label: '米易县'}
            , {value: '510422', label: '盐边县'}
            ]}
            , {value: '510500', label: '泸州市', children:[{value: '510502', label: '江阳区'}
            ...
            , {value: '511400', label: '眉山市', children:[{value: '511402', label: '东坡区'}
            ...
            , {value: '510700', label: '绵阳市', children:[{value: '510703', label: '涪城区'}
            ...
            , {value: '512000', label: '资阳市', children:[{value: '512002', label: '雁江区'}
            , {value: '512021', label: '安岳县'}
            , {value: '512022', label: '乐至县'}
            , {value: '512081', label: '简阳市'}
            ]}
            , {value: '511700', label: '达州市', children:[{value: '511702', label: '通川区'}
            ...
            , {value: '510900', label: '遂宁市', children:[{value: '510903', label: '船山区'}
            , {value: '510904', label: '安居区'}
            , {value: '510921', label: '蓬溪县'}
            , {value: '510922', label: '射洪县'}
            , {value: '510923', label: '大英县'}
            ]}
            , {value: '513200', label: '阿坝藏族羌族自治州', children:[{value: '513201', label: '马尔康市'}
            ...
            , {value: '511800', label: '雅安市', children:[{value: '511802', label: '雨城区'}
            ...
            {value: '520000', label: '贵州省', children:[{value: '520200', label: '六盘水市', children:[{value: '520201', label: '钟山区'}
            , {value: '520203', label: '六枝特区'}
            , {value: '520221', label: '水城县'}
            , {value: '520222', label: '盘县'}
            ]}
            , {value: '520400', label: '安顺市', children:[{value: '520402', label: '西秀区'}
            ...
            , {value: '520500', label: '毕节市', children:[{value: '520502', label: '七星关区'}
            ...
            , {value: '520100', label: '贵阳市', children:[{value: '520102', label: '南明区'}
            ...
            , {value: '520300', label: '遵义市', children:[{value: '520302', label: '红花岗区'}
            ...
            , {value: '520600', label: '铜仁市', children:[{value: '520602', label: '碧江区'}
            ...
            , {value: '522600', label: '黔东南苗族侗族自治州', children:[{value: '522601', label: '凯里市'}
            ...
            , {value: '522700', label: '黔南布依族苗族自治州', children:[{value: '522701', label: '都匀市'}
            ...
            , {value: '522300', label: '黔西南布依族苗族自治州', children:[{value: '522301', label: '兴义市'}
            ...
            {value: '530000', label: '云南省', children:[{value: '530900', label: '临沧市', children:[{value: '530902', label: '临翔区'}
            ...
            , {value: '533100', label: '德宏傣族景颇族自治州', children:[{value: '533102', label: '瑞丽市'}
            , {value: '533103', label: '芒市'}
            , {value: '533122', label: '梁河县'}
            , {value: '533123', label: '盈江县'}
            , {value: '533124', label: '陇川县'}
            ]}
            , {value: '533300', label: '怒江傈僳族自治州', children:[{value: '533301', label: '泸水市'}
            , {value: '533323', label: '福贡县'}
            , {value: '533324', label: '贡山独龙族怒族自治县'}
            , {value: '533325', label: '兰坪白族普米族自治县'}
            ]}
            , {value: '532600', label: '文山壮族苗族自治州', children:[{value: '532601', label: '文山市'}
            ...
            , {value: '530100', label: '昆明市', children:[{value: '530102', label: '五华区'}
            ...
            , {value: '530600', label: '昭通市', children:[{value: '530602', label: '昭阳区'}
            ...
            , {value: '530800', label: '普洱市', children:[{value: '530802', label: '思茅区'}
            ...
            , {value: '530300', label: '曲靖市', children:[{value: '530302', label: '麒麟区'}
            ...
            , {value: '532300', label: '楚雄彝族自治州', children:[{value: '532301', label: '楚雄市'}
            ...
            , {value: '530400', label: '玉溪市', children:[{value: '530402', label: '红塔区'}
            ...
            , {value: '532500', label: '红河哈尼族彝族自治州', children:[{value: '532501', label: '个旧市'}
            ...
            , {value: '532800', label: '西双版纳傣族自治州', children:[{value: '532801', label: '景洪市'}
            , {value: '532822', label: '勐海县'}
            , {value: '532823', label: '勐腊县'}
            ]}
            , {value: '533400', label: '迪庆藏族自治州', children:[{value: '533401', label: '香格里拉市'}
            , {value: '533422', label: '德钦县'}
            , {value: '533423', label: '维西傈僳族自治县'}
            ]}
            ]},
            {value: '540000', label: '西藏自治区', children:[{value: '540500', label: '山南市', children:[{value: '540502', label: '乃东区'}
            ...
            , {value: '540100', label: '拉萨市', children:[{value: '540102', label: '城关区'}
            , {value: '540103', label: '堆龙德庆市'}
            ...
            , {value: '540200', label: '日喀则市', children:[{value: '540202', label: '桑珠孜区'}
            ...
            , {value: '540300', label: '昌都市', children:[{value: '540302', label: '卡若区'}
            ...
            , {value: '540400', label: '林芝市', children:[{value: '540402', label: '巴宜区'}
            ...
            , {value: '542400', label: '那曲地区', children:[{value: '542421', label: '那曲县'}
            ...
            , {value: '542500', label: '阿里地区', children:[{value: '542521', label: '普兰县'}
            ...
            {value: '610000', label: '陕西省', children:[{value: '610400', label: '咸阳市', children:[{value: '610402', label: '秦都区'}
            ...
            , {value: '611000', label: '商洛市', children:[{value: '611002', label: '商州区'}
            ...
            , {value: '610900', label: '安康市', children:[{value: '610902', label: '汉滨区'}
            ...
            , {value: '610300', label: '宝鸡市', children:[{value: '610302', label: '渭滨区'}
            ...
            , {value: '610600', label: '延安市', children:[{value: '610602', label: '宝塔区'}
            ...
            , {value: '610800', label: '榆林市', children:[{value: '610802', label: '榆阳区'}
            ...
            , {value: '610700', label: '汉中市', children:[{value: '610702', label: '汉台区'}
            ...
            , {value: '610500', label: '渭南市', children:[{value: '610502', label: '临渭区'}
            ...
            , {value: '610100', label: '西安市', children:[{value: '610102', label: '新城区'}
            ...
            , {value: '610200', label: '铜川市', children:[{value: '610202', label: '王益区'}
            , {value: '610203', label: '印台区'}
            , {value: '610204', label: '耀州区'}
            , {value: '610222', label: '宜君县'}
            ]}
            ]},
            {value: '620000', label: '甘肃省', children:[{value: '622900', label: '临夏回族自治州', children:[{value: '622901', label: '临夏市'}
            ...
            , {value: '620100', label: '兰州市', children:[{value: '620102', label: '城关区'}
            ...
            , {value: '620500', label: '天水市', children:[{value: '620502', label: '秦州区'}
            ...
            , {value: '621100', label: '定西市', children:[{value: '621102', label: '安定区'}
            ...
            , {value: '620800', label: '平凉市', children:[{value: '620802', label: '崆峒区'}
            ...
            , {value: '621000', label: '庆阳市', children:[{value: '621002', label: '西峰区'}
            ...
            , {value: '620700', label: '张掖市', children:[{value: '620702', label: '甘州区'}
            ...
            , {value: '620600', label: '武威市', children:[{value: '620602', label: '凉州区'}
            , {value: '620621', label: '民勤县'}
            , {value: '620622', label: '古浪县'}
            , {value: '620623', label: '天祝藏族自治县'}
            ]}
            , {value: '623000', label: '甘南藏族自治州', children:[{value: '623001', label: '合作市'}
            ...
            , {value: '620400', label: '白银市', children:[{value: '620402', label: '白银区'}
            , {value: '620403', label: '平川区'}
            , {value: '620421', label: '靖远县'}
            , {value: '620422', label: '会宁县'}
            , {value: '620423', label: '景泰县'}
            ]}
            , {value: '620900', label: '酒泉市', children:[{value: '620902', label: '肃州区'}
            ...
            , {value: '620300', label: '金昌市', children:[{value: '620302', label: '金川区'}
            , {value: '620321', label: '永昌县'}
            ]}
            , {value: '621200', label: '陇南市', children:[{value: '621202', label: '武都区'}
            ...
            {value: '630000', label: '青海省', children:[{value: '632600', label: '果洛藏族自治州', children:[{value: '632621', label: '玛沁县'}
            ...
            , {value: '630200', label: '海东市', children:[{value: '630202', label: '乐都区'}
            ...
            , {value: '630100', label: '西宁市', children:[{value: '630102', label: '城东区'}
            ...
            , {value: '632300', label: '黄南藏族自治州', children:[{value: '632321', label: '同仁县'}
            , {value: '632322', label: '尖扎县'}
            , {value: '632323', label: '泽库县'}
            , {value: '632324', label: '河南蒙古族自治县'}
            ]}
            ]},
            {value: '640000', label: '宁夏回族自治区', children:[{value: '640500', label: '中卫市', children:[{value: '640502', label: '沙坡头区'}
            , {value: '640521', label: '中宁县'}
            , {value: '640522', label: '海原县'}
            ]}
            , {value: '640300', label: '吴忠市', children:[{value: '640302', label: '利通区'}
            ...
            , {value: '640400', label: '固原市', children:[{value: '640402', label: '原州区'}
            , {value: '640422', label: '西吉县'}
            , {value: '640423', label: '隆德县'}
            , {value: '640424', label: '泾源县'}
            , {value: '640425', label: '彭阳县'}
            ]}
            , {value: '640200', label: '石嘴山市', children:[{value: '640202', label: '大武口区'}
            , {value: '640205', label: '惠农区'}
            , {value: '640221', label: '平罗县'}
            ]}
            , {value: '640100', label: '银川市', children:[{value: '640104', label: '兴庆区'}
            ...
            {value: '650000', label: '新疆维吾尔自治区', children:[{value: '650100', label: '乌鲁木齐市', children:[{value: '650102', label: '天山区'}
            ...
            , {value: '654000', label: '伊犁哈萨克自治州', children:[{value: '654002', label: '伊宁市'}
            ...
            , {value: '653000', label: '克孜勒苏柯尔克孜自治州', children:[{value: '653001', label: '阿图什市'}
            , {value: '653022', label: '阿克陶县'}
            , {value: '653023', label: '阿合奇县'}
            , {value: '653024', label: '乌恰县'}
            ]}
            , {value: '650200', label: '克拉玛依市', children:[{value: '650202', label: '独山子区'}
            ...
            , {value: '652700', label: '博尔塔拉蒙古自治州', children:[{value: '652701', label: '博乐市'}
            ...
            , {value: '650400', label: '吐鲁番市', children:[{value: '650402', label: '高昌区'}
            , {value: '650421', label: '鄯善县'}
            , {value: '650422', label: '托克逊县'}
            ]}
            , {value: '653200', label: '和田地区', children:[{value: '653201', label: '和田市'}
            ...
            , {value: '650500', label: '哈密市', children:[{value: '650502', label: '伊州区'}
            , {value: '650521', label: '巴里坤哈萨克自治县'}
            , {value: '650522', label: '伊吾县'}
            ]}
            , {value: '653100', label: '喀什地区', children:[{value: '653101', label: '喀什市'}
            ...
            , {value: '654200', label: '塔城地区', children:[{value: '654201', label: '塔城市'}
            ...
            , {value: '652800', label: '巴音郭楞蒙古自治州', children:[{value: '652801', label: '库尔勒市'}
            ...
            , {value: '652300', label: '昌吉回族自治州', children:[{value: '652301', label: '昌吉市'}
            ...
            , {value: '652900', label: '阿克苏地区', children:[{value: '652901', label: '阿克苏市'}
            ...
            , {value: '654300', label: '阿勒泰地区', children:[{value: '654301', label: '阿勒泰市'}
    ...
    watch: {
        //监控tempPcdText值的变化， 实现从父组件向子组件赋值的功能
        //父组件中的示例代码如下：
    ...
    methods: {
        valueChanged(){
            ...
            if (this.selectedOptions.length == 3){
                for(var p of this.pcdOptions){
                    if (p.value == this.selectedOptions[0]){
                        for(var c of p.children){
                            if (c.value == this.selectedOptions[1]){
                                for (var d of c.children){
                                    if (d.value == this.selectedOptions[2]){
                                        names[0] = p.label
                                        names[1] = c.label
                                        names[2] = d.label
                                        break;
            ...
            let ret = {"codes": this.selectedOptions, "names": names}
            this.$emit('pcdChange', ret) //触发父组件的事件，向父组件传值，父组件的相关代码如下：
            /*pcdChange(msg){
            this.pcdCode = msg;
            alert(msg);
            alert('aa-' + this.pcdCode);
            }*/
            //<add-pcd v-model="addForm.pcdCode" @pcdChange="pcdChange"></add-pcd>
        }
    },
    mounted(){
    }
